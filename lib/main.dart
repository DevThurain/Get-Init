...
import 'package:get_init/home/home_page.dart';
  ...
  Widget build(BuildContext context) {
    return GetMaterialApp(
      ...
      getPages: [
        ...
        GetPage(name: DetailPage.routeName, page: () => const DetailPage()),
        GetPage(name: CounterPage.routeName, page: () => const CounterPage()),
        GetPage(name: NetworkCallPage.routeName, page: () => const NetworkCallPage()),
      ],
